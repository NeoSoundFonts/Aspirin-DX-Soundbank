...
- Updated Synth Brass 2, Synth Brass 3, Ober Brass, and Stack Synth Brass.
...
- Added Windchime Pad.
- Trimmed Loops for New Century.
- Changed Airplane Wave with Yingchun Soul's Version.
...
- Added LA Sanxianqin (Bank 8 Program 106), Waves made by Yingchun Soul.
- Improved "Rave" patch.
- Added VCSL Dan Tranh.
- Added French Horn 2.
- Added Brass Section samples to original French Horn instrument.
- Added VCSL SanXianQin to GM Program 106.
